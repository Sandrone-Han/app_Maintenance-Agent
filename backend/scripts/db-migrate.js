...
const tables = [
  ...
  {
    name: 'SCHEDULE_RESULT_ADJUSTMENT',
    statements: [`
  CREATE TABLE SCHEDULE_RESULT_ADJUSTMENT (
    ID VARCHAR2(36) PRIMARY KEY,
    RESULT_ID VARCHAR2(36) NOT NULL,
    JOB_ID VARCHAR2(36) NOT NULL,
    WORK_DATE DATE NOT NULL,
    SHIFT_NAME NVARCHAR2(20) NOT NULL,
    ORIGINAL_MEMBER_ID VARCHAR2(36),
    ORIGINAL_PERSON_NAME NVARCHAR2(50) NOT NULL,
    ORIGINAL_TEAM VARCHAR2(10),
    REPLACEMENT_MEMBER_ID VARCHAR2(36),
    REPLACEMENT_PERSON_NAME NVARCHAR2(50) NOT NULL,
    REPLACEMENT_TEAM VARCHAR2(10) NOT NULL,
    REPLACEMENT_ROLE_NAME NVARCHAR2(20) NOT NULL,
    REPLACEMENT_SKILLS_TEXT NVARCHAR2(200),
    LEAVE_TYPE NVARCHAR2(20) NOT NULL,
    REASON NVARCHAR2(500),
    STATUS NVARCHAR2(20) DEFAULT N'生效' NOT NULL,
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    UPDATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CANCELED_AT TIMESTAMP,
    CONSTRAINT FK_RESULT_ADJUSTMENT_RESULT
  ...
  {
    name: 'SCHEDULE_RESULT_SWAP',
    statements: [`
  CREATE TABLE SCHEDULE_RESULT_SWAP (
    ID VARCHAR2(36) PRIMARY KEY,
    SOURCE_RESULT_ID VARCHAR2(36) NOT NULL,
    TARGET_RESULT_ID VARCHAR2(36) NOT NULL,
    JOB_ID VARCHAR2(36) NOT NULL,
    SOURCE_WORK_DATE DATE NOT NULL,
    SOURCE_SHIFT_NAME NVARCHAR2(20) NOT NULL,
    SOURCE_PERSON_NAME NVARCHAR2(50) NOT NULL,
    SOURCE_TEAM VARCHAR2(10),
    SOURCE_ROLE_NAME NVARCHAR2(20),
    SOURCE_SKILLS_TEXT NVARCHAR2(200),
    TARGET_WORK_DATE DATE NOT NULL,
    TARGET_SHIFT_NAME NVARCHAR2(20) NOT NULL,
    TARGET_PERSON_NAME NVARCHAR2(50) NOT NULL,
    TARGET_TEAM VARCHAR2(10),
    TARGET_ROLE_NAME NVARCHAR2(20),
    TARGET_SKILLS_TEXT NVARCHAR2(200),
    REASON NVARCHAR2(500),
    STATUS NVARCHAR2(20) DEFAULT N'生效' NOT NULL,
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    UPDATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CANCELED_AT TIMESTAMP,
    CONSTRAINT FK_RESULT_SWAP_SOURCE
      FOREIGN KEY (SOURCE_RESULT_ID) REFERENCES SCHEDULE_RESULT(ID)
      ON DELETE CASCADE,
    CONSTRAINT FK_RESULT_SWAP_TARGET
      FOREIGN KEY (TARGET_RESULT_ID) REFERENCES SCHEDULE_RESULT(ID)
      ON DELETE CASCADE
  )
  `],
  },
...
const indexes = [
  ...
  'CREATE INDEX IDX_RESULT_ADJUSTMENT_RESULT ON SCHEDULE_RESULT_ADJUSTMENT(RESULT_ID, STATUS)',
  'CREATE INDEX IDX_RESULT_ADJUSTMENT_DATE ON SCHEDULE_RESULT_ADJUSTMENT(WORK_DATE, STATUS)',
  'CREATE INDEX IDX_RESULT_SWAP_SOURCE ON SCHEDULE_RESULT_SWAP(SOURCE_RESULT_ID, STATUS)',
  'CREATE INDEX IDX_RESULT_SWAP_TARGET ON SCHEDULE_RESULT_SWAP(TARGET_RESULT_ID, STATUS)',
  'CREATE INDEX IDX_RESULT_SWAP_JOB ON SCHEDULE_RESULT_SWAP(JOB_ID, STATUS)',
  "CREATE UNIQUE INDEX UX_ADJUSTMENT_ACTIVE_RESULT ON SCHEDULE_RESULT_ADJUSTMENT (CASE WHEN STATUS = N'生效' THEN RESULT_ID END)",
  "CREATE UNIQUE INDEX UX_SWAP_ACTIVE_SOURCE ON SCHEDULE_RESULT_SWAP (CASE WHEN STATUS = N'生效' THEN SOURCE_RESULT_ID END)",
  "CREATE UNIQUE INDEX UX_SWAP_ACTIVE_TARGET ON SCHEDULE_RESULT_SWAP (CASE WHEN STATUS = N'生效' THEN TARGET_RESULT_ID END)",
];
...
async function main() {
  ...
  try {
    ...
    if (await tableExists(connection, 'SCHEDULE_RESULT')) {
      ...
      await addColumnIfMissing(connection, 'SCHEDULE_RESULT', 'IS_BORROWED', "IS_BORROWED NVARCHAR2(10) DEFAULT N'否'");
      ...
      await addColumnIfMissing(connection, 'SCHEDULE_RESULT', 'VALIDATION_RESULT', "VALIDATION_RESULT NVARCHAR2(20) DEFAULT N'通过'");
